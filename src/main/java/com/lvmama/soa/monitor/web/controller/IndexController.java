...
//        return statistics;
    	...
    	Map<String,Integer> statistics = new HashMap<String, Integer>();
    	statistics.put("aaa", 1);
    	statistics.put("bbb", 2);
    	statistics.put("ccc", 3);
    	return statistics;
    }
...
//        return statistics;
    	...
    	Map< String,List<Integer>> statistics =  new HashMap<String, List<Integer>>();
    	statistics.put("app1", new ArrayList());
    	statistics.put("app2", new ArrayList());
    	return statistics;
    }
...
//        return statistics;
    	...
    	Map< String,Integer> statistics =  new HashMap<String, Integer>();
    	statistics.put("app1", 1);
    	statistics.put("app2", 2);
    	return statistics;
    }
...
//        return statistics;
    	...
    	Map<String,List<Map<String,Object>>> statistics=new HashMap<String, List<Map<String, Object>>>();
    	statistics.put("nodes",new ArrayList());
      statistics.put("links",new ArrayList());
    	return statistics;
    }
