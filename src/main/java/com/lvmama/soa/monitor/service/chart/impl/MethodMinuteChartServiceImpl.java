...
@Service("methodMinuteChartService")
public class MethodMinuteChartServiceImpl implements MethodMinuteChartService{
	Log log = LogFactory.getLog(MethodMinuteChartServiceImpl.class);
	
	@Autowired
	DubboMethodDayIPService dubboMethodDayIPService;
	
	private String draw(String appName, String serviceName,String methodName,String chartType,TimeSeries timeseries){
		TimeSeriesCollection xydataset = new TimeSeriesCollection();
		xydataset.addSeries(timeseries);
		
		JFreeChart jfreechart = ChartFactory.createTimeSeriesChart("["+appName+"-"+serviceName+"-"+methodName+"()] "+chartType, "time", chartType, xydataset, true, true, false);
	...
	public String drawSuccessChart(Map<String,Object> param){
		...
		return this.draw(param.get("appName").toString(), param.get("service").toString(),param.get("method").toString(),ChartConst.CHART_TYPE_SUCCESS_TIMES, timeseries);
	}
	...
	public String drawFailChart(Map<String, Object> param) {
		...
		return this.draw(param.get("appName").toString(), param.get("service").toString(),param.get("method").toString(),ChartConst.CHART_TYPE_FAIL_TIMES, timeseries);
	}
	...
	public String drawElapsedAvgChart(Map<String, Object> param) {
		...
		return this.draw(param.get("appName").toString(), param.get("service").toString(),param.get("method").toString(),ChartConst.CHART_TYPE_ELAPSED_AVG, timeseries);
	}
	...
	public String drawElapsedMaxChart(Map<String, Object> param) {
		...
		return this.draw(param.get("appName").toString(), param.get("service").toString(),param.get("method").toString(),ChartConst.CHART_TYPE_ELAPSED_MAX, timeseries);
	}
}
